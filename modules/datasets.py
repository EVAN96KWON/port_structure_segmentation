...
# --------------------------------------------------------------------------------
def get_harbor_idx(root, train=True, is_label=True ,label_num=15, split_size=0.1):
    if train:
        if is_label:
            ...
            for c in classes:
                ...
                _split = int(len(matched_idx) * (1 - split_size))
                train_idx.extend(matched_idx[:_split])
                valid_idx.extend(matched_idx[_split:])
